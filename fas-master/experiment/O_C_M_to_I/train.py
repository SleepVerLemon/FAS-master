...
def train():
    ...
    log = Logger()
    log.open(config.logs + config.tgt_data + '_log_SSDG_resnet18.txt', mode='a')
    log.write("\n----------------------------------------------- [START %s] %s\n\n" % (
    ...
    # cosine_schedule = optim.lr_scheduler.ExponentialLR(optimizer=optimizer, gamma=0.99901336)  #C
